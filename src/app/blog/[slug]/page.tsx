...
export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: data.title, description: data.meta_description || data.excerpt || '',
      images: [{ url: getImageUrl(data.image_url) }], type: 'article',
    },
  }
}
  ...
  return (
    <SiteLayout>
      <article>
        <div className="relative h-64 md:h-80 bg-primary-900">
          ...
          <div className="absolute inset-0 flex items-end">
            <div className="max-w-4xl mx-auto px-4 w-full pb-8">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        publisher: { '@type': 'Organization', name: 'Ankara Parça Eşya Taşıma' },
      })}} />
    </SiteLayout>
  )
}
